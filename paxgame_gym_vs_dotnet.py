...
for i in range(num_episodes):
    ...
    while True:
        ...
        if player_objs[player].minerals >= MAXMINS:
            ...
            #response = requests.post(url = "http://localhost:50586/get2dresult2/" + str(MAXMINS), data = json.dumps(state), headers = headers)  
...
primary_network.save_weights('model_h5/paxgame_gym_vs_dotnet_1k_50k.h5')
